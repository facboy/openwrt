#!/bin/sh
uci set system.@system[0].hostname=router78
uci set network.lan.ipaddr=192.168.1.78/24
uci set network.lan.ip6ifaceid='::78'
...
uci set wireless.@wifi-device[0].channel=52
